...
4. Use the cd command to navigate to the location of "entertainment_center.py"
   (located inside the folder you have downloaded) archive.
5. Type python entertainment_center.py in the command prompt to run the program.

License

This project was created during classes of the Nanodegree Full-Stack Web Developer program, offered by Udacity. Within it there are archives ceded by Udacity. 
Copying "fresh_tomatoes.html", "fresh_tomatoes.py" and "fresh_tomatoes.pyc" is prohibited without the permission of Udacity.